...
class SignUp extends React.Component {
  ...
  //  await fetch('http://localhost:4004/traveller/signup', {
    await fetch('http://13.52.55.245:4004/traveller/signup', {
      method: 'post',
  ...
  render()
  {
    ...
    if(this.props.loginSingup.Redirection_Value === true  && USERTYPE==="traveler")
    {
     Redirecty =  <Redirect to="/home" />
    }
      if(this.props.loginSingup.errors === true || this.state.check_values === true)
    {
      Errors = <p class="error"> Error Signing Up, Please enter valid fields </p>
    }
    return(
      <div>
      {Redirecty}
