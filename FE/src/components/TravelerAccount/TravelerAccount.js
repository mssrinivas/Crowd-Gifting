...
class TravelerAccount extends Component {
  ...
  onSubmitUpdate = (event) => {
   ...
   var url = 'http://13.52.55.245:4004/editprofile/save/' + localStorage.getItem("usernamey") 
    const request = async () => {
  ...
  var url = 'http://13.52.55.245:4004/user/account/' + localStorage.getItem("usernamey")
